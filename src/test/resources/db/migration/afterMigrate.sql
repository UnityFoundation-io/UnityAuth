...
INSERT INTO user (id, email, password, status) VALUES(1, 'person1@test.io', '1234', 'ENABLED');
INSERT INTO user (id, email, password, status) VALUES(2, 'test@test.io', '1234', 'ENABLED');
